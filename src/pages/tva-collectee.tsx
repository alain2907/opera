...
export default function TvaCollecteePage() {
  ...
  const loadTaux = async () => {
    ...
    try {
      ...
      setTaux(data.filter(t => t.type === 'collectee'));
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="p-6 max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">TVA Collectée</h1>

        {/* Formulaire d'ajout */}
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <h2 className="text-xl font-semibold mb-4">Ajouter un taux de TVA collectée</h2>
